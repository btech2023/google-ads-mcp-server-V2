#!/usr/bin/env python3
"""
Script to clean null bytes from Python files in the tests directory.
"""
...
def clean_tests_files():
    # Focus specifically on tests directory
    tests_files = glob.glob("google_ads_mcp_server/tests/**/*.py", recursive=True)
    
    print(f"Found {len(tests_files)} files in tests directory")
